...
class Highscore:
    ...
    def get_highscore(self):
        return self.played_games, self.won_games, self.average_steps_to_win
    ...
    def display_high_scores(self):
        self.winning_rate = self.won_games / self.played_games if self.played_games > 0 else 0
        ...
        display_string = "Played games: {}, Won games: {}, Winning rate: {:.2f}, Average steps to win: {:.2f}".format(self.played_games, self.won_games, self.winning_rate, self.average_steps_to_win)
